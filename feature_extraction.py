...
'''
TODO: Figure out why the y size is 193  (features, labels = np.empty((0,193)))
        That should be the amount of features i think
'''
def parse_audio(label, dir, file_ext='.wav'):
    ...
    for fn in os.listdir(dir):
        if fn.endswith(file_ext):
            ...
            label_index = file_utils.get_label_index(label)
