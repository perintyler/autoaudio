...
def read_file(file_name):
    ...
    y, sr = librosa.load(sample_path, sr=48000)
...
------------------------------------'''
def output_file(outfile, y, sr, ext=""):
...
def remove_background_noise(infile, outfile):
    # reading a file
    y, sr = read_file(infile)
    ...
    # output_file(output_folder, outfile, y_reduced_power, sr, '_pwr')
    # output_file(output_folder, outfile, y_reduced_centroid_s, sr, '_ctr_s')
    # output_file(output_folder, outfile, y_reduced_centroid_mb, sr, '_ctr_mb')
    # output_file(output_folder, outfile, y_reduced_mfcc_up, sr, '_mfcc_up')
    # output_file(output_folder, outfile, y_reduced_mfcc_down, sr, '_mfcc_down')
    # output_file(output_folder, outfile, y_reduced_median, sr, '_median')
    soundfile.write(outfile, y_reduced_power, sr)
    # librosa.output.write_wav(outfile, y_reduced_power, sr)
